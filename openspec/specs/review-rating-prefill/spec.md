# review-rating-prefill Specification

## Purpose
Reading a Jellyfin user's stored rating for an item through the plugin API and
presenting it as the starting state of the review modal, including half-star
display and the movie/TV resolution rules.
## Requirements
